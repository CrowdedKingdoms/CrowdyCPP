...
**17.4.0**. The gate pins CrowdyJS commit
`d6150f57a5562ad9d49bb0e8f3dad78facaacfab` (`crowdyjsParityTarget` in
...
| Surface | CrowdyCPP 0.40.0 | CrowdyJS 17.4.0 | Required public API generation |
|---|---|---|---|
