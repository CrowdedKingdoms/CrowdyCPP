...
CrowdyCPP 0.22.0 (this `dev` line) passes the strict portable-parity gate
against CrowdyJS **14.1.0**. The gate pins CrowdyJS commit
`90f4b7bb2562d007aa62d01d4b21abdb76923e9b` (`crowdyjsParityTarget` in
...
| Surface | CrowdyCPP 0.22.0 | CrowdyJS 14.1.0 | Required public API generation |
|---|---|---|---|
