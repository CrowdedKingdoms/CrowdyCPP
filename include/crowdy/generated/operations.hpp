...
/// udp/ConnectUdpProxy.graphql
inline constexpr std::string_view kConnectUdpProxyDocument = R"gql(mutation ConnectUdpProxy {
  connectUdpProxy {
    connected
    serverIp6
    serverClientPort
...
inline constexpr std::string_view kConnectUdpProxyOperationName = "ConnectUdpProxy";

/// udp/DisconnectUdpProxy.graphql
inline constexpr std::string_view kDisconnectUdpProxyDocument = R"gql(mutation DisconnectUdpProxy {
  disconnectUdpProxy
})gql";
inline constexpr std::string_view kDisconnectUdpProxyOperationName = "DisconnectUdpProxy";

/// udp/SendActorUpdate.graphql
inline constexpr std::string_view kSendActorUpdateDocument = R"gql(mutation SendActorUpdate($input: ActorUpdateRequestInput!) {
  sendActorUpdate(input: $input)
})gql";
inline constexpr std::string_view kSendActorUpdateOperationName = "SendActorUpdate";

/// udp/SendAudioPacket.graphql
inline constexpr std::string_view kSendAudioPacketDocument = R"gql(mutation SendAudioPacket($input: ClientAudioPacketInput!) {
  sendAudioPacket(input: $input)
})gql";
inline constexpr std::string_view kSendAudioPacketOperationName = "SendAudioPacket";

/// udp/SendChannelMessage.graphql
inline constexpr std::string_view kSendChannelMessageDocument = R"gql(mutation SendChannelMessage($input: ChannelMessageInput!) {
  sendChannelMessage(input: $input)
})gql";
inline constexpr std::string_view kSendChannelMessageOperationName = "SendChannelMessage";

/// udp/SendClientEvent.graphql
inline constexpr std::string_view kSendClientEventDocument = R"gql(mutation SendClientEvent($input: ClientEventNotificationInput!) {
  sendClientEvent(input: $input)
})gql";
inline constexpr std::string_view kSendClientEventOperationName = "SendClientEvent";

/// udp/SendSingleActorMessage.graphql
inline constexpr std::string_view kSendSingleActorMessageDocument = R"gql(mutation SendSingleActorMessage($input: SingleActorMessageInput!) {
  sendSingleActorMessage(input: $input)
})gql";
inline constexpr std::string_view kSendSingleActorMessageOperationName = "SendSingleActorMessage";

/// udp/SendTextPacket.graphql
inline constexpr std::string_view kSendTextPacketDocument = R"gql(mutation SendTextPacket($input: ClientTextPacketInput!) {
  sendTextPacket(input: $input)
})gql";
inline constexpr std::string_view kSendTextPacketOperationName = "SendTextPacket";

/// udp/SendVoxelUpdate.graphql
inline constexpr std::string_view kSendVoxelUpdateDocument = R"gql(mutation SendVoxelUpdate($input: VoxelUpdateRequestInput!) {
  sendVoxelUpdate(input: $input)
})gql";
inline constexpr std::string_view kSendVoxelUpdateOperationName = "SendVoxelUpdate";

/// udp/UdpNotifications.graphql
inline constexpr std::string_view kUdpNotificationsDocument = R"gql(subscription UdpNotifications {
  udpNotifications {
    __typename
    ...
    ... on SingleActorMessageNotification {
      appId
      chunkX
      chunkY
      chunkZ
...
inline constexpr std::string_view kUdpNotificationsOperationName = "UdpNotifications";

/// udp/UdpProxyConnectionStatus.graphql
inline constexpr std::string_view kUdpProxyConnectionStatusDocument = R"gql(query UdpProxyConnectionStatus {
  udpProxyConnectionStatus {
    connected
    serverIp6
    serverClientPort
...
inline constexpr std::string_view kUdpProxyConnectionStatusOperationName = "UdpProxyConnectionStatus";
