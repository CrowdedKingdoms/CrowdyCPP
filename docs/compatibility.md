...
CrowdyCPP 0.40.0 passes the strict portable-parity gate against CrowdyJS
**17.3.0**. The gate pins CrowdyJS commit
`613fd277c905ed8f41f9962304d25c8058dc4485` (`crowdyjsParityTarget` in
...
| Surface | CrowdyCPP 0.40.0 | CrowdyJS 17.3.0 | Required public API generation |
|---|---|---|---|
